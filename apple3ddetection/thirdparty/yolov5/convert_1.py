...
parser.add_argument('--json_path', default='/home/psdz/dataset/apple_dataset/test_data/detection/ground_truth.json', type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='./label', type=str, help="specify where to save the output dir of labels")
